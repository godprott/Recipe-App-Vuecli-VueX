...
//this.$route.params.id //dung this.$route.params de lay du lieu tu link.
 /* created() {   //khoi tao gia trị
    if(this.$route.params.id) //neu id ton tai
        {
          console.log("Update: get ok: "+this.$route.params.id);
          this.data = {...this.getid(this.$route.params.id)}; //né đc store thay đổi theo
...
created() {   //khoi tao gia trị
  ...
  methods: {
    add(){ //dang theo cach 1, theo cach 2 tu sua
